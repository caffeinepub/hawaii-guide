    ...
    <div className="min-h-screen bg-sand font-body">
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('/assets/generated/hawaii-hero.dim_1440x600.png')",
          }}
        />
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-white/85 text-lg sm:text-xl md:text-2xl max-w-2xl mx-auto leading-relaxed mb-10 font-light">
            Eight islands of volcanic wonder, turquoise waters, and aloha spirit
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-ocean-deep/60 text-lg max-w-2xl mx-auto leading-relaxed">
              Each island has its own personality, landscape, and magic. Find
              the one that calls to your soul.
            </p>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-ocean-deep/60 text-lg max-w-2xl mx-auto leading-relaxed">
              From riding world-class waves to dancing under the stars, Hawaii
              offers adventures for every spirit.
            </p>
          </div>
      ...
      <section ref={diningRef} id="dining" className="py-24 bg-sand">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-ocean-deep/60 text-lg max-w-2xl mx-auto leading-relaxed">
              Hawaii's culinary scene is as diverse as its landscapes — from
              roadside poke stands to oceanfront fine dining, every bite tells a
      ...
      <section ref={tipsRef} id="tips" className="py-24 bg-ocean-pale">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-ocean-deep/60 text-lg max-w-2xl mx-auto leading-relaxed">
              Everything you need to know for a seamless, respectful, and
      ...
      <section className="relative py-20 overflow-hidden bg-ocean-deep">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center px-4">
          ...
          <p className="text-white/75 text-lg mb-10 leading-relaxed">
            From the volcanic peaks of the Big Island to the emerald valleys of
            Kauai — paradise is calling. Start planning your dream trip today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              type="button"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-white/50 text-sm text-center">
              ...
              <Heart className="w-3.5 h-3.5 inline text-coral fill-coral" />{" "}
              using{" "}
              <a
