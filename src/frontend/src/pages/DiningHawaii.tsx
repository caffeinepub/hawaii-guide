...
const cuisineTypes = [
  ALL_CUISINES,
  ...Array.from(new Set(diningPosts.map((p) => p.cuisineType))),
];
const islands = [
  ALL_ISLANDS,
  ...Array.from(new Set(diningPosts.map((p) => p.island))),
];
    ...
    <div className="min-h-screen bg-sand font-body">
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-end overflow-hidden pt-16">
        <div
          ...
          style={{
            backgroundImage:
              "url('/assets/generated/dining-fruit-market.dim_800x600.png')",
          }}
        />
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          ...
          <p className="text-white/85 text-lg sm:text-xl max-w-2xl leading-relaxed font-light">
            From roadside poke stands to oceanfront fine dining — every bite
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-ocean-deep/60 text-lg max-w-2xl mx-auto leading-relaxed">
              Hawaii's culinary scene is as diverse as its landscapes — a
              melting pot of Polynesian, Asian, and American flavors shaped by
              the islands' unique culture and bounty.
            </p>
          </div>
          ...
          {filteredPosts.length > 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-ocean-deep/55 text-base mb-6">
                Try adjusting your search or filters to discover more island
                flavors.
              </p>
              <button
                type="button"
      ...
      <section className="relative py-20 overflow-hidden bg-ocean-deep">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center px-4">
          ...
          <p className="text-white/75 text-lg mb-10 leading-relaxed">
            Explore the full Hawaii travel guide — discover islands, activities,
            and everything you need for the perfect trip.
          </p>
          <Link
            to="/"
