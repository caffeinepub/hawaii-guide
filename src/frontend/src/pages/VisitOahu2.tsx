        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-ocean-deep/60 text-lg max-w-2xl mx-auto leading-relaxed">
              From world-famous beaches to historic landmarks, Oahu packs
              unforgettable experiences into one incredible island.
            </p>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-ocean-deep/60 text-lg max-w-2xl mx-auto leading-relaxed">
              Surf legendary waves, snorkel with sea turtles, hike volcanic
              craters, and honor history — Oahu offers unforgettable adventures.
            </p>
          </div>
      ...
      <section ref={diningRef} id="dining" className="py-24 bg-sand">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-ocean-deep/60 text-lg max-w-2xl mx-auto leading-relaxed">
              From legendary poke bowls to North Shore shrimp trucks — Oahu's
              food scene is as diverse and delicious as its landscapes.
            </p>
          </div>
      ...
      <section ref={tipsRef} id="tips" className="py-24 bg-ocean-pale">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-ocean-deep/60 text-lg max-w-2xl mx-auto leading-relaxed">
              Everything you need to know to navigate Oahu like a local —
              transportation, neighborhoods, weather, and insider tips.
            </p>
          </div>
